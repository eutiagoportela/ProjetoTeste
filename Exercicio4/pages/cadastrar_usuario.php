...
if(isset($_POST['enviar'])) {
    ...
    if(count($erro) == 0) {
        ...
        $logManager1->log('info', 'Cadastro de Usuario - '.$nome .' - Efetuado por '.$_SESSION['usuario']." = ".$_SESSION['nome']);
        $logManager2 = new DataBaseLogManager();
        $logManager2->log('info', 'Cadastro de Usuario - '.$nome .' - Efetuado por '.$_SESSION['usuario']." = ".$_SESSION['nome']);
