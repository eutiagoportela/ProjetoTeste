...
$logManager1->log('info', 'Usuario - '.$id .' - Deletado por '.$_SESSION['usuario']." = ".$_SESSION['nome']);
$logManager2 = new DataBaseLogManager();
$logManager2->log('info', 'Usuario - '.$id .' - Deletado por '.$_SESSION['usuario']." = ".$_SESSION['nome']);
