...
if(isset($_POST['enviar'])) {
    ...
    if(count($erro) == 0) {
        ...
        if($mysqli)
        {
            ...
            $logManager1->log('info', 'Usuario - '.$nome .' - Editado por '.$_SESSION['usuario']." = ".$_SESSION['nome']);
            $logManager2 = new DataBaseLogManager();
            $logManager2->log('info', 'Usuario - '.$nome .' - Editado por '.$_SESSION['usuario']." = ".$_SESSION['nome']);
        }
